...
def buildUrls(urls):
    link1 = 'https://stackoverflow.com' + urls[2].get('href')
    link2 = 'https://stackoverflow.com' + urls[3].get('href')
    link3 = 'https://stackoverflow.com' + urls[4].get('href')
    link4 = 'https://stackoverflow.com' + urls[5].get('href')
    link5 = 'https://stackoverflow.com' + urls[6].get('href')
    link6 = 'https://stackoverflow.com' + urls[7].get('href')
    link7 = 'https://stackoverflow.com' + urls[8].get('href')
    link8 = 'https://stackoverflow.com' + urls[9].get('href')
    link9 = 'https://stackoverflow.com' + urls[10].get('href')
    link10 = 'https://stackoverflow.com' + urls[11].get('href')
